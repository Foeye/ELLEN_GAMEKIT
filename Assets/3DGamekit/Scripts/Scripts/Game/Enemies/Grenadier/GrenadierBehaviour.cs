...
namespace Gamekit3D
{
    ...
    public class GrenadierBehaviour : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            ...
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Music_Boss),gameObject); //切至boss音乐
        }
        ...
        public void StartAttack()
        {
            ...
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Grenadier_Attack_Vox), gameObject);// 大怪攻击音效
        }
        ...
        public void Hit()
        {
            ...
            AkSoundEngine.PostEvent("Grenadier_Hit", gameObject);// 大怪受击音效


            m_EnemyController.animator.SetTrigger(hashHitParam);
            m_CoreMaterial.SetColor("_Color2", Color.red);
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Grenadier_Gets_Red), gameObject);// 大怪红瘟了
        }
        ...
        public void Die()
        {
            ...
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Grenadier_Death_Vox), gameObject);// 大怪死亡语音
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Music_Victory), gameObject);// 切至胜利音乐
        ...
        public void ActivateShield()
        {
            ...
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Grenadier_ShieldUp), gameObject);// 大怪技能音效2
        }
        ...
        public void DeactivateShield()
        {
            ...
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Grenadier_ShieldDown), gameObject);// 大怪技能音效2
        }

        public void ReturnVulnerable()
        {
            m_CoreMaterial.SetColor("_Color2", m_OriginalCoreMaterial);
            //AkSoundEngine.PostEvent("Grenadier_Gets_Vulnerable", gameObject);// 大怪垂死, NG触发时机很怪
        }
        ...
        public void PlayStep()
        {
            ...
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Grenadier_Feet_And_Armour), gameObject);// 大怪脚步
        }

        public void Shoot()
        {
            throwAudioPlayer.PlayRandomClip();
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Grenadier_Shoot_Attack), gameObject);// 大怪技能音效1
