    ...
    public class GrenadierGrenade : Projectile
    {
        ...
        public void Explosion()
        {
            if (explosionPlayer)
            {
                ...
                AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Grenadier_Grenade_Explosion), gameObject);//爆炸音效
            }
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                if (d != null){
                    ...
                    AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Ellen_Hurt_Vox), gameObject);
                }
        ...
        protected virtual void OnCollisionEnter(Collision other)
        {
            if (bouncePlayer != null)
            {
                ...
                AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Grenadier_Grenade_Bounce), gameObject);//手榴弹砸地音效
