    ...
    public class ChomperBehavior : MonoBehaviour, IMessageReceiver
    {
        ...
        void PlayStep(int frontFoot) {
            if (frontStepAudio != null && frontFoot == 1) {
                ...
                //Debug.Log("This");
                AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Chomper_Run_Ft_Front), gameObject);
            }
            else if (backStepAudio != null && frontFoot == 0) {
                backStepAudio.PlayRandomClip();
                AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Chomper_Run_Ft_Back), gameObject);
            }
        }
        ...
        public void Grunt ()
        {
            ...
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Chomper_Idle_Vox), gameObject);
        }
        // IEnumerator WaitAndGrunt()
        // {
        //     while(true)
        //     {
        ...
        //     yield return new WaitForSeconds(5);
        //     AkSoundEngine.PostEvent("Chomper_Idle_Vox", gameObject);
        ...
        //     yield return StartCoroutine("WaitAndGrunt");
        // }
        public void Spotted()
        {
        ...
        public void StartPursuit()
        {
            ...
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Monster_Aware), gameObject);// 切进战斗的音乐
        ...
        public void StopPursuit()
        {
            ...
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Monster_Unaware), gameObject);// 切出战斗的音乐
        ...
        public void WalkBackToBase()
        {
            ...
            //AkSoundEngine.PostEvent("Monster_Unaware", gameObject);// 切出战斗的音乐，放这里call太多次了
        }
        ...
        public void AttackBegin()
        {
            ...
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Chomper_Attack_Vox), gameObject);
        }
        ...
        public void Death(Damageable.DamageMessage msg)
        {
            ...
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Chomper_Death_Vox), gameObject);// 小怪死亡语音
            AkSoundEngine.PostEvent(AudioSys.GetWwiseEventName(EllenWwiseEvent.Monster_Unaware), gameObject);// 切掉小怪的音乐
        }
        ...
        public void ApplyDamage(Damageable.DamageMessage msg)
        {
            ...
            AkSoundEngine.PostEvent("Chomper_Hit_Impact", gameObject);
        }
